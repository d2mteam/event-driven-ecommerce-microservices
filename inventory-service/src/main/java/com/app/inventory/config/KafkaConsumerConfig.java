...
import com.app.inventory.messaging.NonRetryableOrderEventException;
...
public class KafkaConsumerConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(
        ...
        errorHandler.addNotRetryableExceptions(
                ...
                InventoryEventConflictException.class
        );
        return errorHandler;
    }
    ...
    public NewTopic inventoryEventsTopic(
            InventoryMessagingProperties messagingProperties,
            KafkaRetryProperties retryProperties
    ) {
        return TopicBuilder.name(messagingProperties.inventoryEvents())
                .partitions(retryProperties.partitions())
                .replicas(retryProperties.replicationFactor())
                .build();
    }

    @Bean
    public NewTopic inventoryDeadLetterTopic(
            KafkaRetryProperties properties
    ) {
